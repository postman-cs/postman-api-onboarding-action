...
Only the latest `v3.x.y` release (tracked by the rolling `v3` alias) receives security fixes. Older tags remain published for reproducibility and are never retroactively modified.
